...
<!--Fuente https://tailgrids.com/components/datepicker

flowbite: https://flowbite.com/docs/components/datepicker/

flyon: https://flyonui.com/docs/third-party-plugins/flatpickr/
...
<template>
  <section class="bg-white py-20 dark:bg-dark">
    <div class="container">
      <div class="mx-auto w-full max-w-[340px]" ref="datepickerContainerRef">
        ...
        >
          ...
          <div class="flex items-center space-x-3 pt-4 sm:space-x-5">
            <button
              id="cancelBtn"
              class="flex h-[50px] w-full items-center justify-center rounded-md bg-red-600 text-base font-medium text-white hover:bg-opacity-90"
              @click="handleCancel"
            >
              Remove
            </button>
            <button
              id="applyBtn"
              class="flex h-[50px] w-full items-center justify-center rounded-md bg-blue-600 text-base font-medium text-white hover:bg-blue-dark"
              @click="handleApply"
            >
              Done
            </button>
