            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="flex flex-col gap-2 p-4 border-b border-gray-200 pt-6">
                    ...
                    <div class="flex gap-2">
                        <input type="date" v-model="startDate" class="border px-2 py-1 rounded w-1/2" />
                        <input type="date" v-model="endDate" class="border px-2 py-1 rounded w-1/2" />
                    </div>
                    <div class="flex gap-2">
                        <!-- Botón Filtrar -->
                        <button @click="fetchSummary()"
                            ...
                            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    ...
                                    <path d="M19.8691 17.1201L18.8691 16.1201" stroke="#292D32" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                </g>
                            </svg>
                        </button>
                        <!-- Botón Reset -->
                        <button v-if="startDate || endDate" @click="resetFilter"
                            ...
                            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <path
                                        ...
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M18.1487 15.99L15.6387 13.48" stroke="#ff0000" stroke-width="1.5"
                                        stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M18.1291 13.5098L15.6191 16.0198" stroke="#ff0000" stroke-width="1.5"
                                        stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path opacity="0.4"
                ...
                <div class="p-4 md:p-5 text-center">
                    <svg class="mx-auto mb-4 text-gray-400 w-12 h-12 dark:text-gray-200" viewBox="0 0 24 24" fill="none"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            <g id="Arrow / Arrow_Circle_Down">
                                <path id="Vector"
                                    ...
                                    stroke="#a39f9f" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                </path>
                            </g>
                        </g>
                    </svg>
                    ...
                    <button @click="store.download('pdf', startDate, endDate)" data-modal-hide="popup-modal"
                        ...
                        <svg class="h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 64"
                    ...
                    <button @click="store.download('excel', startDate, endDate)" data-modal-hide="popup-modal"
                        ...
                        <svg class="h-5" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"
