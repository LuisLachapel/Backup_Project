      ...
      <!--Footer de descargas-->
            <div class="p-4 md:p-5 text-center">
               ...
               <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿En que formato deseas hacer la descarga?</h3>
                <button @click="store.download('pdf',startDate,endDate)"  data-modal-hide="popup-modal" type="button" class=" mr-4 text-white bg-gray-50 hover:bg-gray-100 focus:ring-4 focus:outline-none dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                ...
                <button @click="store.download('excel',startDate,endDate)" data-modal-hide="popup-modal" type="button" class="text-white bg-gray-50 hover:bg-gray-100 focus:ring-4 focus:outline-none dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
