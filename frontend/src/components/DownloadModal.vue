...
<!-- Main modal -->
<div v-if="show" tabindex="-1" aria-hidden="true" class="fixed inset-0 flex items-center overflow-y-auto overflow-x-hidden justify-center w-full  max-h-full bg-black/50">
          ...
          <div class="flex gap-2">
            ...
            <div class="p-4 md:p-5 text-center">
               ...
               <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿En que formato deseas hacer la descarga?</h3>
                <button  data-modal-hide="popup-modal" type="button" class=" mr-4 text-white bg-gray-50 hover:bg-gray-100 focus:ring-4 focus:outline-none dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                ...
                <button data-modal-hide="popup-modal" type="button" class="text-white bg-gray-50 hover:bg-gray-100 focus:ring-4 focus:outline-none dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
