          ...
          <form class="p-4" @submit.prevent="save">
            <div class="grid gap-4 mb-4">
              <div>
                ...
                <input v-model="name" type="text" class="w-full p-2.5 border rounded-lg" placeholder="Ingrese el título"
                  maxlength="50" />
              ...
              <div>
                ...
                <input v-model="code" type="text" class="w-full p-2.5 border rounded-lg" placeholder="Ingrese el codigo"
                  maxlength="25" />
              ...
              <div>
                ...
                <textarea v-model="description" rows="4" class="w-full p-2.5 border rounded-lg"
                  placeholder="Ingrese la descripción" maxlength="200"></textarea>
              ...
              <div v-if="props.permission">
                ...
                <label class="inline-flex items-center cursor-pointer">
                  <input type="checkbox" v-model="active" class="sr-only peer" :disabled="!props.permission">
